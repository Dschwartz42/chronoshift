...
export const EXAMPLE_VIDEOS: Partial<VideoRecord>[] = [
  ...
  {
    id: "b7c2943a-e7ee-419e-abb9-2a34f74085a3",
    prompt: "What if the Cuban Missile Crisis went nuclear?",
    title: "Thirteen Days to Ashes: The Nuclear October",
    duration_seconds: 316,
    thumbnail_url: "https://iqafznzwckyodegoyanc.supabase.co/storage/v1/object/public/videos/b7c2943a-e7ee-419e-abb9-2a34f74085a3/thumbnail.jpg",
    video_url: "https://iqafznzwckyodegoyanc.supabase.co/storage/v1/object/public/videos/b7c2943a-e7ee-419e-abb9-2a34f74085a3/video.mp4",
    is_public: true,
    status: "complete",
  },
];
